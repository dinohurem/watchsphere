      ...
      <div className="min-h-screen flex bg-white">
        ...
        <div className="flex-1 flex flex-col relative">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-8">
            <div className="w-full max-w-[450px] flex flex-col gap-8 text-center">
              <div className="w-16 h-16 mx-auto bg-green-100 rounded-full flex items-center justify-center">
                <svg className="w-8 h-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h1 className="text-[32px] font-bold text-[#1d1d1f] tracking-[0.4px]">
                Account Created!
              </h1>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8">
          <div className="w-full max-w-[450px] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              <button
                type="button"
                className="w-full h-[44px] flex items-center justify-center gap-2 bg-white border border-[rgba(29,29,31,0.1)] rounded-full text-[16px] font-semibold text-[#1d1d1f] hover:bg-gray-50 transition-colors tracking-[0.08px] leading-5"
              >
