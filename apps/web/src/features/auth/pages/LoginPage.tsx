          ...
          <div className="w-full max-w-[450px] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full h-[44px] flex items-center justify-center gap-2 bg-white border border-[rgba(29,29,31,0.1)] rounded-full text-[16px] font-semibold text-[#1d1d1f] hover:bg-gray-50 transition-colors disabled:opacity-50 tracking-[0.08px] leading-5"
              >
